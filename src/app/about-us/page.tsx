          ...
          <div className="container">
            <div className={styles.bodyInner}>
              ...
              <div className={styles.bodyCopy}>
                ...
                <p>
                  Most of our work sits at the intersection of China-linked growth and global teams: org design
                  questions, cross-border reporting, and hiring narratives that need to work in more than one market. If
                  that sounds like your world, we would like to hear from you.
                </p>
              </div>
            </div>
          </div>
